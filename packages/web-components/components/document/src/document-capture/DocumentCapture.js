    ...
    <div class='section | flow ${this.isPortraitCaptureView ? 'portrait' : 'landscape'}'>
      <div class='id-video-container'>
        ...
        <div class='video-footer sticky'>
          ...
          <h4 class='text-base font-normal title-color description reset-margin-block'>Certifique-se de que todos os cantos estão visíveis e que não há brilho.</h4>
          <div class='actions' hidden>
            <button id='capture-id-image' class='button icon-btn | center' type='button'>
              ...
              <span class='visually-hidden'>Documento de captura</span>
            </button>
          </div>
