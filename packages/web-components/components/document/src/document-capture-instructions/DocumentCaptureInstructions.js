    ...
    <div id="document-capture-instructions-screen" class="flow center">
        ...
        <div class="flow instructions-wrapper">
            <div class="instructions">
                ...
                <p class="instruction-header font-bold text-base">Boa luz</p>
                <p class="instruction-body text-xs font-medium">
                  Certifique-se de que a imagem é tirada num ambiente bem iluminado, onde o documento de identificação seja fácil de ler.
                </p>
            </div>
        </div>
        <div class="instructions">
            ...
            <div>
                <p class="instruction-header font-bold text-base">Limpar imagem</p>
                <p class="instruction-body text-xs font-medium">
