...
function scwTemplateString() {
  ...
  <div hidden id='id-entry-screen' class='flow center'>
    ...
    <header>
      ...
      <p>
        Vamos usá-lo para verificar a sua identidade.
      </p>
      <p>
      ...
      <div class='id-video-container ${this.isPortraitCaptureView ? 'portrait' : 'landscape'}'>
        <div class='actions'>
          <button id='re-capture-id-image' class='button icon-btn' type='button'>
            ...
            <span class='visually-hidden'>Re-Capturar</span>
          </button>
          <button id='select-id-image' class='button icon-btn' type='button'>
            ...
            <span class='visually-hidden'>Aceitar  Imagem</span>
          </button>
        </div>
  ...
  <div hidden id='back-of-id-entry-screen' class='flow center'>
    ${
      ...
      <div class="nav">
        ...
        <button data-type='icon' type='button' id='back-id-entry-close' class='close-iframe icon-btn'>
          ...
          <span class='visually-hidden'>Feche a moldura de Verificação de Identidade do Smile.</span>
        </button>
      </div>
      `
        : ''
    ...
    <div class='flow'>
      <div class='document-tips'>
        ...
        <div>
          <p>Verifique a iluminação.</p>
          <p>
           Tire a foto do seu documento de identidade em um ambiente bem iluminado, onde o texto esteja fácil de ler, e livre de reflexos no cartão.
          </p>
        </div>
      </div>
      <div class='document-tips'>
        ...
        <div>
          <p>Certifique-se de que esteja em foco.</p>
          <p>
           Certifique-se de que a foto do documento de identidade que você enviar não esteja borrada: você deve ser capaz de ler o texto no documento.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class='id-video-container ${this.isPortraitCaptureView ? 'portrait' : 'landscape'}'>
        ...
        <div class='actions' hidden>
          <button id='capture-back-of-id-image' class='button icon-btn | center' type='button'>
            ...
            <span class='visually-hidden'>Capturar</span>
          </button>
        </div>
      </div>
      ...
      <p style='margin-inline: auto; max-inline-size: 10rem'>
        <svg viewBox="0 0 90 9" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g clipPath="url(#clip0_1923_23296)">
              <path d="M58.5141 6.02913C58.5644 6.37005 58.8092 6.77098 59.4839 6.77098C60.0578 6.77098 60.336 6.56623 60.336 6.23338C60.336 5.90053 60.142 5.75579 59.788 5.71292L58.5988 5.58482C57.5612 5.47387 56.9539 4.86819 56.9539 3.87872C56.9539 2.77779 57.7801 2.04401 59.4335 2.04401C61.2135 2.04401 61.9221 2.88874 61.9894 3.88679H60.3195C60.2687 3.51157 59.965 3.27253 59.442 3.27253C58.9783 3.27253 58.6577 3.44349 58.6577 3.75062C58.6577 3.99774 58.8097 4.18534 59.2141 4.21964L60.1844 4.30486C61.4918 4.41582 62.0397 5.04672 62.0397 6.0962C62.0397 7.21377 61.3477 7.999 59.4504 7.999C57.5532 7.999 56.9534 7.02667 56.8691 6.02862H58.5141V6.02913Z" fill="#02aaad" />
